...
قم بمسح الرقم 9647505442494ووضع رقمك لكن لا تضعه بغير هذه الطريقه
...
sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 9647505442494, "TshAke TEAM" , "", bot_id)
end
...
if text:match("^source$") or text:match("^اصدار$") or text:match("^الاصدار$") or text:match("^السورس$") or text:match("^سورس$") then
   ...
   local text =  [[
• <code>اهلا بك في سورس يونس</code> 🦁ֆ

• <code>المطورين</code> ⚜️:-
• <b>TshAkE TEAM </b>

• <code>قناه السورس</code> ❇️:-
•<b> Channel</b> | @DEV_youyou
